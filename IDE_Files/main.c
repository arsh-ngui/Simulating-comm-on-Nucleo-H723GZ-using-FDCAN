...
void Configure_FDCAN3_Filter(void);
void Check_For_Incoming_Messages(void);
/* USER CODE END PFP */
...
static void MX_FDCAN3_Init(void)
{
  ...
  hfdcan3.Init.RxFifo0ElmtSize = 0;
...
void Send_CANFD_Message(void)
{
  ...
  uint8_t TxData[16] = {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88,
                        0x99, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0x00};

  TxHeader.Identifier = 0x1F4;
